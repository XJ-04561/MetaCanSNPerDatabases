...
TABLES = [TABLE_NAME_SNP_ANNOTATION, TABLE_NAME_REFERENCES, TABLE_NAME_NODES, TABLE_NAME_TREE, TABLE_NAME_CHROMOSOMES]

SNP_COLUMN_SNP_ID,				SNP_COLUMN_SNP_ID_TYPE				= "id",				("INTEGER", "PRIMARY KEY"	)
...
CHROMOSOMES_COLUMN_ID,			CHROMOSOMES_COLUMN_ID_TYPE			= "id",				("INTEGER", "NOT NULL"		)
...
SNP_APPEND = [
	f"FOREIGN KEY ({SNP_COLUMN_CHROMOSOMES_ID}) REFERENCES {TABLE_NAME_CHROMOSOMES} ({REFERENCE_COLUMN_GENOME_ID})"
]
REFERENCE_APPEND = []
NODES_APPEND = []
TREE_APPEND = [
